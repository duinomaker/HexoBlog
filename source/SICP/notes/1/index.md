...
**费马小定理**：若 $n$ 是质数，则对于任意 $a$ 不是 $n$ 的倍数，都有 $a^n\equiv a\\;\\;({\rm mod}\\;n)$，它的另一个形式是 $a^{n-1}\equiv1\\;\\;({\rm mod}\\;n)$，在<a href="/SICP/assets/miller-rabin/" target="_self">${\rm Miller\text{-}Rabin}$素性测试</a>中得以应用。